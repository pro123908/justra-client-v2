    ...
    <div className="public-shell">
      <nav className="public-nav">
        ...
        <div className="actions">
          <span className="muted-2" style={{ fontSize: 13 }}>Don't have an account?</span>
      ...
      <div className="center-shell">
        <div className="auth-card">
          ...
          <p className="sub">
            Justra uses your wallet to sign milestone agreements and release escrow.
            Sessions are scoped per-wallet — your private keys never leave Phantom.
          </p>
          <button className="wallet-btn" onClick={handlePhantom} disabled={loading}>
            ...
            <span className="stack" style={{ alignItems: 'flex-start' }}>
              ...
              <span className="muted-2" style={{ fontSize: 12, fontWeight: 500 }}>Mainnet-beta</span>
            </span>
            <Ico.arrowR className="arrow" />
          </button>
          <div className="divider" />
          <button className="wallet-btn" disabled>
            <span className="wallet-mark" style={{ background: 'linear-gradient(135deg,#f7931a,#e76f00)' }}>S</span>
            <span className="stack" style={{ alignItems: 'flex-start' }}>
              <span>Continue with Solflare</span>
              <span className="muted-2" style={{ fontSize: 12, fontWeight: 500 }}>Browser extension</span>
            </span>
            <Ico.arrowR className="arrow" />
          </button>
          <p className="fineprint">
            By connecting you agree to Justra's <a>Terms</a> and <a>Privacy Policy</a>.
            New to wallets? <a>Install Phantom →</a>
          </p>
        </div>
      </div>
    </div>
