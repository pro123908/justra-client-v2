/* Settings screen — appearance + account preferences */

function SettingsScreen({ t, setTweak, role }) {
  const themes = [
    { value: "light", label: "Light", desc: "Calm warm whites with sage accents." },
    {
      value: "dark",
      label: "Dark",
  ...
  return (
    <div className="page">
      ...
      <div className="tabs">
        <button className="tab active">Appearance</button>
        <button className="tab">Account</button>
        <button className="tab">Notifications</button>
        <button className="tab">
          Wallets <span className="count">2</span>
        </button>
            ...
            return (
              ...
              >
                ...
                <div className="row-between">
                  <div>
                    <div style={{ fontWeight: 700, fontFamily: "var(--display)" }}>{opt.label}</div>
          ...
          >
            {["compact", "cozy", "comfy"].map((d) => (
              <button
                ...
                style={{
                  border: "none",
                  background: t.density === d ? "var(--surface)" : "transparent",
                  color: t.density === d ? "var(--ink)" : "var(--ink-3)",
                  fontWeight: 600,
                  fontSize: 13,
                  padding: "8px 18px",
                  borderRadius: 7,
                  ...
                  boxShadow: t.density === d ? "var(--sh-1)" : "none",
                  transition: "all 0.15s",
                }}
              >
                {d}
        ...
        <div className="card-pad">
          ...
          >
            ...
            <div className="meta">
              ...
              <div className="sub">{role === "provider" ? "7Hk2…q4Bn" : "4Yp9…wZ12"}</div>
            </div>
